...
public:
     ...
     */
    ColorTFChart(const vtkSmartPointer< vtkRenderWindow >& figureRenWin, const vtkSmartPointer< vtkRenderWindow >& chartRenWin, vtkSmartPointer< vtkColorTransferFunction > tf, const std::__cxx11::string& xLabel, const std::__cxx11::string& yLabel, double minBound, double maxBound);
